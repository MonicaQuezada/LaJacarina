      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="buscador" style="margin-left: 28rem;">
            ...
            <button id="search-button" class="btn" type ="button" onclick="buscador(); search();" style="background-color: #fff;color:black;padding:0.001rem"><i class="fas fa-info"></i></button>
          </div>
        </div>
      </div>
      <div class="row">
